...
#
# Created: Sat Nov 12 15:35:19 2016
...
"")
        ...
        self.lne_dni.setGeometry(QtCore.QRect(50, 10, 131, 20))
        ...
        self.lne_nom_ape.setGeometry(QtCore.QRect(270, 10, 251, 20))
...
"}")
        ...
        self.boton_pagar = QtWidgets.QPushButton(self.tab_3)
        self.boton_pagar.setGeometry(QtCore.QRect(360, 360, 81, 23))
        font = QtGui.QFont()
...
"")
        ...
        form_cuotas_pagar.setTabOrder(self.tabWidget_3, self.lne_nom_ape)
        form_cuotas_pagar.setTabOrder(self.lne_nom_ape, self.tabWidget_4)
